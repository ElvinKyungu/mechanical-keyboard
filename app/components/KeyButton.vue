...
<template>
  <button
    ...
    :class="[sizeClass, colorClass, $attrs.class]"
    :data-code="code"
    :data-macro="macro"
    :data-color="color"
    @click="handleClick"
...
.key-button.wave-orange {
  ...
  box-shadow:
    ...
    /* orange-500 */ 0 0 40px rgba(249, 115, 22, 0.4),
...
.key-button.wave-red {
  ...
  box-shadow:
    ...
    /* red-500 */ 0 0 40px rgba(239, 68, 68, 0.4),
...
.key-button.wave-yellow {
  ...
  box-shadow:
    ...
    /* yellow-500 */ 0 0 40px rgba(234, 179, 8, 0.4),
...
.key-button.wave-green {
  ...
  box-shadow:
    ...
    /* green-500 */ 0 0 40px rgba(34, 197, 94, 0.4),
...
.key-button.wave-blue {
  ...
  box-shadow:
    ...
    /* blue-500 */ 0 0 40px rgba(59, 130, 246, 0.4),
...
.key-button.wave-purple {
  ...
  box-shadow:
    ...
    /* purple-500 */ 0 0 40px rgba(168, 85, 247, 0.4),
...
.key-button.key-pressed {
  ...
  box-shadow:
    0 0 10px rgba(161, 161, 170, 0.5),
    /* zinc-400 */ 0 2px 4px rgba(161, 161, 170, 0.4);
}
</style>
