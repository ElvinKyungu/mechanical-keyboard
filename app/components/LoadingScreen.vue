  ...
  >
    ...
    >
      <div class="text-center space-y-8">
        <!-- Animated Logo -->
        <div class="relative">
          <div class="w-24 h-24 border-4 border-blue-500/30 rounded-full animate-spin"></div>
          <div class="absolute inset-2 w-20 h-20 border-4 border-t-blue-500 border-r-transparent border-b-transparent border-l-transparent rounded-full animate-spin" style="animation-direction: reverse; animation-duration: 1.5s;"></div>
          <div class="absolute inset-4 w-16 h-16 bg-gradient-to-br from-blue-500 to-purple-600 rounded-full animate-pulse"></div>
        </div>
