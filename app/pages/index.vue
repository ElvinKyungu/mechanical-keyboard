...
useSeoMeta({
  ...
  description:
    "Interactive 3D keyboard with beautiful wave animations built with Nuxt 4, GSAP, and Tailwind CSS",
  ogDescription:
    "Experience smooth 3D animations and wave effects on a virtual keyboard",
...
<template>
  <div>
    <ClientOnly>
      ...
      <!-- Instructions Panel -->
      <div
        class="fixed top-4 left-4 bg-black/80 backdrop-blur-sm rounded-xl p-6 text-white max-w-md text-white"
      >
        ...
        <div class="space-y-3 text-sm">
          <div class="flex items-center space-x-3">
            ...
            <span
              >Press <kbd class="bg-zinc-700 px-2 py-1 rounded">Escape</kbd> -
              Orange wave</span
            >
          </div>
          ...
          <div class="flex items-center space-x-3">
            ...
            <span
              >Press <kbd class="bg-zinc-700 px-2 py-1 rounded">Enter</kbd> -
              Green wave</span
            >
          </div>
          ...
          <div class="flex items-center space-x-3">
            ...
            <span
              >Press <kbd class="bg-zinc-700 px-2 py-1 rounded">Shift</kbd> -
              Yellow wave</span
            >
          </div>
          ...
          <div class="flex items-center space-x-3">
            ...
            <span
              >Press <kbd class="bg-zinc-700 px-2 py-1 rounded">Ctrl</kbd> - Red
              wave</span
            >
          </div>
          ...
          <div class="flex items-center space-x-3">
            ...
            <span
              >Press <kbd class="bg-zinc-700 px-2 py-1 rounded">Alt</kbd> - Blue
              wave</span
            >
          </div>
          ...
          <div class="flex items-center space-x-3">
            ...
            <span
              >Press <kbd class="bg-zinc-700 px-2 py-1 rounded">Win</kbd> -
              Purple wave</span
            >
          </div>
        </div>
      ...
      <!-- Performance Stats -->
      <div
        class="fixed top-4 right-4 bg-black/80 backdrop-blur-sm rounded-xl p-4 text-white"
      >
        <div class="text-sm space-y-2">
          ...
          <div class="text-xs text-zinc-400">
            ...
            <span class="text-teal-500"
              ><NuxtLink to="https://elvin.vercel.app/" target="_blank"
                >By Elvin Code</NuxtLink
              ></span
            >
          </div>
        </div>
