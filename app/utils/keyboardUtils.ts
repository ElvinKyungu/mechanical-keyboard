export const keyboardUtils = {
  ...
  isValidKeyCode(code: string): boolean {
    return /^(Key[A-Z]|Digit\d|Arrow(Up|Down|Left|Right)|Space|Enter|Shift(Left|Right)|Control(Left|Right)|Alt(Left|Right)|Meta(Left|Right)|Tab|CapsLock|Escape|Backspace|Delete|Home|End|PageUp|PageDown)$/.test(
      code,
    );
  },
